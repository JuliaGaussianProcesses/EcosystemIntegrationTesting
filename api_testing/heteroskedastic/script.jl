...
# ╔═╡ c2aab525-b985-45cb-8cc6-6d32542b1733
begin
...
build_lik(θ) = GaussianLikelihood(θ.lik.noise_var + 1e-6)
# build_lik(θ) = f -> Normal(f, √(θ.lik.noise_var))

# ╔═╡ 617559cb-9675-49a4-9516-5ed232a084e2
build_latent_gp(θ) = LatentGP(build_gp(θ.gp), build_lik(θ), θ.jitter)
...
git-tree-sha1 = "75ab093eb1502242e74635f338911e657ffaf0ff"
