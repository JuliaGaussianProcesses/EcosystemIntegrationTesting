...
# ╔═╡ 0e8e595e-3e25-11ec-3337-0720944a184b
begin
...
include("../utils_optimize_loss.jl")

# ╔═╡ 333a4502-c744-4b37-bde9-3deefae4cd77
begin
...
# ╔═╡ 58292bd8-3316-422e-a4e9-617bb4412ce8
function plotdata()
	plot(xlabel="year", ylabel="CO2", legend=:bottomright)
	scatter!(xtrain, ytrain, ms=2, label="train")
	scatter!(xtest, ytest, ms=2, label="test")
end

# ╔═╡ d917bef8-a6c0-4977-9539-31d427c5f380
plotdata()

# ╔═╡ 84d6b514-3c35-490e-9290-0c9a520383aa
θ_init = (;
    se1 = (;
	    σ = positive(exp(4.0)),
	    ℓ = positive(exp(4.0)),
...
git-tree-sha1 = "603fde842910e6d33bfce2ce7d0e0a0851d8e21e"
